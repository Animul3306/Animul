...
<div id="container">  
	...
	<div class="borderbox-medium">	
		<form action="list3" name="RadioForm">	 
			<input type="radio" id="radio1" name="radiokeyword" value="동물병원" ${centerType21 eq 1 ? "checked" : ""} onclick="checkRadio()" />
			<label>동물병원</label>
			<input type="radio" id="radio2" name="radiokeyword" value="반려동물용품" ${centerType21 eq 2 ? "checked" : ""} onclick="checkRadio()" />
			<label>펫샾</label>	
			<input type="radio" id="radio3" name="radiokeyword" value="동물보호" ${centerType21 eq 3 ? "checked" : ""} onclick="checkRadio()" disabled />
			<label>동물보호센터</label>
		</form>
