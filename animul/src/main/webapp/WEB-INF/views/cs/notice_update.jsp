...
<div class="notice_update">
			<form action="notice_update2">
				...
				<div class="container">
					<input type="hidden" name="notice_id" value="${vo2.notice_id}">
                  
					
					<div class="mb-3">
					<select name="notice_status" class="form-select"
						aria-label="Default select example">
						<option selected>${vo2.notice_status}</option>
					...
					<div class="mb-3">
						<input name="notice_title" type="text" class="form-control"
							...
							value="${vo2.notice_title}">
					</div>
					
					<select name="notice_category" class="form-select"
						aria-label="Default select example">
						<option selected>${vo2.notice_category}</option>
