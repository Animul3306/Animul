	...
	<main class="d-flex flex-nowrap">
		...
		<div class="flex-shrink-0 p-3" style="width: 280px;">
			...
			<ul class="list-unstyled ps-0">
				<li class="mb-1"><a href="faq1.jsp"><button
							class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed"
							data-bs-toggle="collapse" data-bs-target="#home-collapse"
							aria-expanded="true">회원정보</button></a></li>
				<li class="mb-1"><a href="faq2.jsp"><button
							class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed"
							data-bs-toggle="collapse" data-bs-target="#home-collapse"
							aria-expanded="true">진료비 조회</button></a></li>
				<li class="mb-1"><a href="faq3.jsp"><button
							class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed"
							data-bs-toggle="collapse" data-bs-target="#home-collapse"
							aria-expanded="true">질병 검색</button></a></li>
				<li class="mb-1"><a href="faq4.jsp"><button
							class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed"
							data-bs-toggle="collapse" data-bs-target="#home-collapse"
							aria-expanded="true">주변시설 찾기</button></a></li>
			</ul>
			...
			<ul class="list-unstyled ps-0">
				<li class="mb-1"><a href=""><button
							class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed"
							data-bs-toggle="collapse" data-bs-target="#home-collapse"
							aria-expanded="true">안내/이벤트</button></a></li>
			...
			<ul class="list-unstyled ps-0">
				<li class="mb-1"><a href="ask_list"><button
							class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed"
							data-bs-toggle="collapse" data-bs-target="#home-collapse"
			...
			<form action="ask_insert">
				...
				<div class="container">
					...
					<div class="d-grid gap-2 d-md-flex justify-content-md-end">
						...
						<a href="cs.jsp"><button class="btn btn-primary" type="button">취소</button></a>
					</div>
				</div>
			</form>
