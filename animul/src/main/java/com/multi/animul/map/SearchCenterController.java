...
public class SearchCenterController {
	...
	@Autowired
	SearchCenterService service;
 
	@RequestMapping(value="/list1") 
	public void list1(PageVO pageVO, Model model) { //start , end
 		pageVO.setStartEnd();
		
		List<SearchCenterVO> list = service.list1(pageVO);
...
//		System.out.println(pageVO.toString());
	...
	public void list2(String centerType, String centerAddr1, PageVO pageVO, Model model) {		
		...
		List<SearchCenterVO> list = service.list2(pageVO);
 		System.out.println("list2 : " + list.toString());
 		System.out.println("list2 pageVO : " + pageVO.getCenterType()); 				
	...
	public void list3(String centerType2, String keywordSearch1, PageVO pageVO, Model model) {		
		...
		List<SearchCenterVO> list = service.list3(pageVO);
		System.out.println(list.toString());
